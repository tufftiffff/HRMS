...
<header>
    ...
    <div class="user-info">
        <a href="{{ route('employee.dashboard') }}" style="text-decoration: none; color: inherit;">
            <i class="fa-regular fa-bell"></i> &nbsp; Employee
        </a>
    </div>
</header>

<div class="container">
    {{-- UPDATED: Included the employee sidebar instead of the admin one --}}
    ...
    <button type="button" onclick="window.location='{{ route('employee.dashboard') }}'">
        <i class="fa-solid fa-chart-pie"></i> Dashboard
    </button>
    <button type="button" onclick="window.location='{{ route('employee.onboarding.index') }}'">
        <i class="fa-solid fa-list-check"></i> My Onboarding
    </button>
    <button type="button" onclick="window.location='{{ route('employee.training.index') }}'">
        <i class="fa-solid fa-graduation-cap"></i> My Training
    </button>
    <button type="button" onclick="window.location='{{ route('employee.leave.view') }}'">
        <i class="fa-solid fa-list-ul"></i> View my leave
    </button>
    <button type="button" onclick="window.location='{{ route('employee.leave.apply') }}'">
...
(function () {
    ...
    chatForm.addEventListener('submit', async function (e) {
        ...
        try {
            const res = await fetch('/employee/assistant/chat', {
                method: 'POST',
                headers: {
