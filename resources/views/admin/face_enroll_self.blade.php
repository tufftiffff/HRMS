...
<body>
  <header>
    ...
    <div class="user-info">
      <a href="{{ route('admin.profile') }}" style="color:inherit; text-decoration:none;"><i class="fa-regular fa-bell"></i> &nbsp; {{ Auth::user()->name ?? 'Employee' }}</a>
    </div>
  </header>
  <div class="container">
    @include('admin.layout.sidebar')
    <main>
      <a href="{{ route('admin.dashboard') }}" class="back-link"><i class="fa-solid fa-arrow-left"></i> Back</a>
      ...
      <div class="enroll-page">
        <div class="enroll-card">
          ...
          @else
            <form method="POST" action="{{ route('admin.face.enroll.self.post') }}" enctype="multipart/form-data" id="enroll-form">
              @csrf
