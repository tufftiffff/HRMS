...
<aside class="sidebar">
  ...
  <div class="sidebar-group {{ $openSection === 'attendance' ? 'open' : '' }}">
    ...
    <ul class="submenu">
      ...
      {{-- Attendance status update (employee) --}}
  ...
  <div class="sidebar-group {{ $openSection === 'payroll' ? 'open' : '' }}">
    ...
    <ul class="submenu">
      ...
      <li><a href="{{ route('employee.payroll.salary_adjustments') }}" class="{{ request()->routeIs('employee.payroll.salary_adjustments*') ? 'active' : '' }}">Salary adjustments</a></li>
